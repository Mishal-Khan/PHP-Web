...
<table style="font-family: arial, sans-serif; 
  ...
  width: 99%; margin-top: 20px; border-radius: 20px; border-color: blue " border="1">
...
<div class="form-group">
	<button type="submit" class="btn bg-primary" name="updateboq"> Update </button>
</div>
	</form>

<table style="font-family: arial, sans-serif; border-radius: 40px;
  border-collapse: collapse; color: black;
  width: 100%; margin-top: 25px;  padding: 5px; border-color: black; " border="2">
