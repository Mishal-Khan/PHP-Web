...
<body>
 <h2 style="color:darkblue; height: 80px; font-size: 42px; font-weight: bold;" class="mb-6">Add Item</h2>
  ...
  <div class="form-group row" >
    ...
    <div class="col-sm-4" >      
    <input type="number" class="form-control" name="ProRef" value=<?php echo $sid ?> readonly>
      </div>
</div>
...
<table style="font-family: arial, sans-serif; 
 ...
 <input type="text" id="BOQItemName" name="BOQItemName" class="form-control" required>
        </td>   
...
<div class="form-group">
	<button type="submit" class="btn bg-primary" name="save2"> Add Item </button>
</div>
	</form>
...
<?php
  ...
  $sql="SELECT * FROM `boq` WHERE `ProRef`= '$sid'";
